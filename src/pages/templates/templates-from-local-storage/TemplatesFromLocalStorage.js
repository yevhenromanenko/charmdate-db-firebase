...
const TemplatesFromLocalStorage = async (setFirstLetterContent, setLetter, firstLetter, ladyId, setSelectedMail, setSelectedGift, setSelectedPrivate, setSelectedVideo) => {

    const letter = await getLetterFromServer(firstLetter, ladyId) || [];
